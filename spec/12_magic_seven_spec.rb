...
describe MagicSeven do
  ...
  describe '#subtract_random_number' do
    context 'when previous step is 10 and random_number is 3' do
  ...
  describe '#play' do
    context 'when the random number is ...' do
      ...
      subject(:game_four) { described_class.new(8) }

      it 'will return 7' do
        expect(game_four.play).to eq(7)
      end
    end

    context 'when the random number is ...' do
      # remove the 'x' before running this test
      subject(:game_five) { described_class.new(37) }
    ...
    context 'when the random number is ...' do
      # remove the 'x' before running this test
      subject(:game_six) { described_class.new(83) }

      it 'will return 7' do
        expect(game_six.play).to eq(7)
      end
    end
  end
end
